...
Motion::Project::App.setup do |app|
  ...
  app.name = 'RubyMotionContributors'
  app.identifier = 'com.your_domain_here.rubymotioncontributors'
  ...
  app.development do
    ...
    app.provisioning_profile = "signing/rubymotioncontributors.mobileprovision"
  end
